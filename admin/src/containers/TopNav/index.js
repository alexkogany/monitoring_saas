...
class TopNav extends Component {
  constructor(props) {
    ...
    //this.store.subscribe(() => {  
          //alert('subscribed for counter actions', store.getState());
  ...
  componentDidMount() {  
    const pusher = new Pusher('d457ae5d1dc04d0748c5', {
      cluster: 'ap2',
      encrypted: true
    });
          ...
          <div className="user d-inline-block">
            <UncontrolledDropdown className="dropdown-menu-right">
              <DropdownToggle className="p-0" color="empty">
                <span className="name mr-1">{user.email}</span>
                <span>
